...
const UpdateSaleStyled = styled.div`
...
export const UpdateSale = ({ handleClose, sale }) => {
  ...
  React.useEffect(() => {
    if (sale) {
      setDateStart(sale.dateStart);
      setDateEnd(sale.dateEnd);
    }
  }, [sale]);
    ...
    <UpdateSaleStyled>
      ...
      >
        <div className="flex flex-col pb-4">
          <Heading title={"Update sale"}></Heading>
